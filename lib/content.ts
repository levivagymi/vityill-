 ...
 *  Falls back to HERO_BANNER where no distinct shot exists yet. */
export const EXPERIENCE_SCENE_IMAGES: Record<ExperienceSlug, string> = {
  ...
  erdo: U('photo-1472214103451-9374bd1c798e', 1920),
  vilagitas: U('photo-1505691938895-1758d7feb511', 1920),
  kilatas: U('photo-1501854140801-50d01698950b', 1920),
  klima: HERO_BANNER,
  tv: HERO_BANNER,
  konyha: U('photo-1484154218962-a197022b5858', 1920),
}
