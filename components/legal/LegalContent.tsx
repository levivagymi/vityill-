  ...
  return (
    <>
      ...
      <main className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
        <p className="text-xs font-sans uppercase tracking-wider text-muted-foreground mb-10">
        ...
        <div className="space-y-10">
          {sections.map((s, i) => (
            <Reveal key={i} y={24}>
              ...
              <p className="font-sans text-muted-foreground leading-[1.85] text-base whitespace-pre-line">{s.body}</p>
            </Reveal>
          ))}
        </div>
      </main>
